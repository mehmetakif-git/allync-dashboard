...
import { Edit3, Save, X, Building2, FolderOpen, TrendingUp, HardDrive, BarChart3, Eye, ArrowLeft, Upload } from 'lucide-react';

export default function DriveServiceManagement() {
  ...
  const [serviceContent, setServiceContent] = useState({
    ...
    description_en: 'File management via WhatsApp with Google Drive integration. Upload, organize, and share files directly through WhatsApp conversations.',
    description_tr: 'WhatsApp üzerinden Google Drive dosya yönetimi. WhatsApp konuşmaları üzerinden dosya yükleyin, düzenleyin ve paylaşın.',
    features_en: [
    ...
    features_tr: [
      'WhatsApp dosya yükleme',
      'Dosya arama',
      'Otomatik düzenleme',
      'Dosya paylaşımı',
      'Dosya önizleme',
      'Yapay zeka dosya etiketleme',
      'Depolama yönetimi',
      'Versiyon geçmişi',
    ],
    pricing: {
      starter: { price: 149, features: ['Up to 10GB storage', 'Basic file management', 'Email support'] },
      professional: { price: 299, features: ['Up to 100GB storage', 'Advanced search', 'File versioning', 'Priority support'] },
      enterprise: { price: 599, features: ['Unlimited storage', 'Custom integrations', 'Dedicated support', 'Advanced analytics'] },
    },
  ...
  const companiesUsingService = [
    {
      ...
      completedAppointments: 542,
      avgResponseTime: '1.8 sec',
      status: 'active',
    },
    {
      id: '2',
      name: 'File Management Inc',
  ...
  const handleSaveContent = async () => {
    ...
    console.log('Drive Service Content Updated:', serviceContent);
  };
        ...
        <div className="bg-gradient-to-br from-yellow-500 to-yellow-700 rounded-2xl p-8 text-white">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold mb-2">Google Drive Service</h1>
              <p className="text-yellow-100 text-lg">
                Manage Google Drive integration service. Edit content, view company usage, and monitor analytics.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card backdrop-blur-sm border border-secondary rounded-xl p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Google Drive - Service Management</h2>
