              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    disabled={!isEditing}
                    className={`w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-green-600 ${!isEditing && 'cursor-not-allowed opacity-70'}`}
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <textarea
                    ...
                    disabled={!isEditing}
                    rows={4}
                    className={`w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-green-600 resize-none ${!isEditing && 'cursor-not-allowed opacity-70'}`}
                  />
                </div>
                <div>
                  ...
                  <div className="space-y-2">
                    {serviceContent.features_en.map((feature, index) => (
                      <input
                        ...
                        disabled={!isEditing}
                        className={`w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-green-600 ${!isEditing && 'cursor-not-allowed opacity-70'}`}
                      />
                    ))}
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-sm text-gray-400">Sheets Connected</span>
                </div>
                ...
                <table className="w-full">
                  <thead className="bg-gray-900/50">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Queries</th>
                      <th className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Sheets</th>
                  ...
                  {companiesUsingService.map((company) => (
                    <tr key={company.id} className="hover:bg-gray-700/50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-gray-300">{company.totalQueries}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-gray-300">{company.sheetsConnected}</td>
        ...
        {activeTab === 'analytics' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
                <p className="text-sm text-gray-400 mb-1">Sheets Connected</p>
