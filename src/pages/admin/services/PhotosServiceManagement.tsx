...
import { Edit3, Save, X, Building2, Image, TrendingUp, Camera, BarChart3, Eye, ArrowLeft, Images } from 'lucide-react';

export default function PhotosServiceManagement() {
  ...
  const [serviceContent, setServiceContent] = useState({
    ...
    description_en: 'Photo management via WhatsApp with Google Photos integration. Upload, organize, and search photos with AI-powered tagging and recognition.',
    description_tr: 'WhatsApp üzerinden Google Photos fotoğraf yönetimi. Yapay zeka destekli etiketleme ve tanıma ile fotoğrafları yükleyin, düzenleyin ve arayın.',
    features_en: [
    ...
    features_tr: [
      'WhatsApp fotoğraf yükleme',
      'Otomatik albüm düzenleme',
      'Fotoğraf arama',
      'Yapay zeka fotoğraf etiketleme',
      'Yüz tanıma',
      'Görüntü tanıma',
      'Akıllı albümler',
    ...
    pricing: {
      starter: { price: 129, features: ['Up to 1,000 photos', 'Basic organization', 'Email support'] },
      professional: { price: 259, features: ['Up to 10,000 photos', 'AI tagging', 'Face recognition', 'Priority support'] },
      enterprise: { price: 519, features: ['Unlimited photos', 'Custom integrations', 'Dedicated support', 'Advanced analytics'] },
    },
  ...
  const companiesUsingService = [
    {
      ...
      activeSince: '2024-11-25',
      package: 'Professional',
      totalAppointments: 1842,
      completedAppointments: 1789,
  ...
  const handleSaveContent = async () => {
    ...
    console.log('Photos Service Content Updated:', serviceContent);
  };
        ...
        <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-8 text-white">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold mb-2">Google Photos Service</h1>
              <p className="text-pink-100 text-lg">
                Manage Google Photos integration service. Edit content, view company usage, and monitor analytics.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card backdrop-blur-sm border border-secondary rounded-xl p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Google Photos - Service Management</h2>
