    ...
    <div className="min-h-screen bg-gradient-to-br from-primary via-secondary to-primary p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-muted mt-1">Send formal invitations to new users via email</p>
        </div>
                ...
                <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-secondary text-sm mt-1">From: info@allyncai.com (via SMTP)</p>
                      <p className="text-muted text-xs mt-2">Professional HTML email with branded template</p>
                    </div>
                  </div>
                </div>
              ) : (
                <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-secondary text-sm mt-1">You will need to share the credentials manually</p>
                    </div>
                  </div>
                </div>
              )}
        ...
        <div className="bg-card backdrop-blur-xl border border-secondary rounded-xl p-6">
          ...
          {invites.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-muted text-sm">Sent invitations will appear here</p>
            </div>
          ) : (
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-secondary">
                    ...
                    <th className="text-left py-3 px-4 text-muted font-medium">Sent Date</th>
                  </tr>
                </thead>
                <tbody>
                  {invites.map((invite) => (
                    <tr key={invite.id} className="border-b border-secondary hover:bg-primary/30 transition-colors">
                      ...
                      <td className="py-4 px-4">
                        <p className="text-secondary text-sm">{invite.email}</p>
                      </td>
                      <td className="py-4 px-4">
