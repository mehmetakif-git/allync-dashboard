...
import { Mail, Lock, Shield, Building2, User as UserIcon, AlertCircle, X, Send } from 'lucide-react';
        ...
        <div className={`grid grid-cols-1 ${isDevelopment ? 'lg:grid-cols-2' : ''} gap-6`}>
          ...
          <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-2xl shadow-2xl shadow-black/70 p-8">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-white mb-2">Allync AI</h1>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm mb-3">
                      For password resets or account access, please contact your system administrator.
                    </p>
                    
                      href="mailto:info@allyncai.com?subject=Account%20Access%20Request"
