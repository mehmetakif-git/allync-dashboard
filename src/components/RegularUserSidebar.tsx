...
export default function RegularUserSidebar({ activePage, onPageChange, isOpen, onClose }: RegularUserSidebarProps) {
            ...
            {activeServices.length > 0 && (
              <>
                <li className="pt-4 pb-2">
                  <div className="text-xs font-semibold text-gray-500 uppercase px-4">Your Services</div>
                </li>
