    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            <label className="text-sm text-gray-400">Service Name (English)</label>
            <p className="text-white font-medium mt-1">{serviceData?.name_en}</p>
          </div>
          <div>
            <label className="text-sm text-gray-400">Service Name (Turkish)</label>
            <p className="text-white font-medium mt-1">{serviceData?.name_tr}</p>
          </div>
          <div className="col-span-2">
            <label className="text-sm text-gray-400">Description (English)</label>
            <p className="text-gray-300 mt-1">{serviceData?.description_en}</p>
          </div>
          <div className="col-span-2">
            <label className="text-sm text-gray-400">Description (Turkish)</label>
            <p className="text-gray-300 mt-1">{serviceData?.description_tr}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            <label className="text-sm text-gray-400 mb-3 block">English</label>
          ...
          <div>
            <label className="text-sm text-gray-400 mb-3 block">Turkish</label>
            <ul className="space-y-2">
      ...
      <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            <label className="text-sm text-gray-400">Delivery Time (English)</label>
            <p className="text-white font-medium mt-1">{serviceData?.delivery_time_en}</p>
          </div>
          <div>
            <label className="text-sm text-gray-400">Delivery Time (Turkish)</label>
            <p className="text-white font-medium mt-1">{serviceData?.delivery_time_tr}</p>
          </div>
          <div>
            <label className="text-sm text-gray-400">Service Status</label>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">{companies.length} active companies</p>
        </div>
      </div>
          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex flex-col gap-2 items-end">
                ...
                <span className="text-xs text-gray-500">{company.plan}</span>
              </div>
            </div>
      ...
      {companies.length === 0 && (
        <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-12 text-center">
          ...
          <p className="text-gray-500">No companies are currently using this service.</p>
        </div>
      )}
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-gray-400">Active Instances</span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
          <div className="text-sm text-gray-400 mb-2">Starter Plan</div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
          <div className="text-sm text-gray-400 mb-2">Professional Plan</div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
          <div className="text-sm text-gray-400 mb-2">Enterprise Plan</div>
