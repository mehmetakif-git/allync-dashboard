...
export default function ContactAdminModal({ isOpen, onClose }: ContactAdminModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-secondary border border-secondary rounded-2xl max-w-md w-full p-6 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-primary/50 border border-secondary rounded-lg">
            <p className="text-xs text-muted mb-2">📧 Support Email:</p>
        ...
        <button
          onClick={onClose}
          className="mt-6 w-full px-4 py-2 bg-gray-700 hover:bg-hover text-white rounded-lg font-medium transition-colors"
        >
          Close
        </button>
      </div>
